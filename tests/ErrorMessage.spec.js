...
test('OrangeHRM - invalid password shows error', async ({ page }) => {
   ...
   // Sanity check: deliberate failing assertion to confirm this file is actually being executed.
   // Action: After you see a failing run, remove this line.
   // If the test still passes with this line present, a different spec file is being run.
